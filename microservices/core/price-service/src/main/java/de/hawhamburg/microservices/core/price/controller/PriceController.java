...
public class PriceController {
    ...
    public Price deletePrice(@RequestBody final Price price, HttpServletResponse response) throws IOException {
        Price priceToRemove = priceService.removePrice(price);
